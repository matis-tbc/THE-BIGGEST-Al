      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold text-slate-100 tracking-tight">
            CU Hyperloop Draft Console
          </h2>
          <p className="mt-2 text-sm text-slate-300">
            Generate high-velocity outreach drafts with tunnel-grade precision.
          </p>
          <p className="mt-2 text-xs text-slate-400">
            Secure Microsoft authentication opens in your browser, then routes you back into mission
            control.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="card">
            ...
            <p className="mt-4 text-xs text-slate-400">
              Sign in with your CU account, then drive the full workflow from data cleanup to
              tunnel-ready draft output.
            </p>
          </div>
        ...
        <div className="text-center">
          <p className="text-xs text-slate-400">
            By signing in, you agree to use this application responsibly and in accordance with your
